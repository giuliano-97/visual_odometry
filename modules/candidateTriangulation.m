function [curr_state, tracked_keypoints] = candidateTriangulation(prev_img,...
    ...
    for i=find(val_cand.')
        ...
        [cand_landmarks, ~, validIndex] = triangulate(...,
        ...
        % negative depth or are too far away
        validIndex = validIndex & cand_landmarks(:,3) > 0 & ...
            cand_landmarks(:, 3) < optionalArgs.maxDepth;
        cand_landmarks = cand_landmarks(validIndex, :);
