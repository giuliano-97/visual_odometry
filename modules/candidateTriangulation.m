function [curr_state, tracked_keypoints] = candidateTriangulation(prev_img, prev_state, curr_img, curr_pose, camera_params,tracker)
...
%             cameraPoses, intrinsics);
        ...
        if calculateAngleDeg(cand_landmark, prev_state.candidate_first_poses{i},...
            ...
            if prev_state.candidate_time_indxs(i) > -max_temporal_recall
                candidate_keypoints = [candidate_keypoints;...
                                       candidate_tracked(i,:)];
                candidate_first_keypoints = [candidate_first_keypoints(i,:);...
                                            prev_state.candidate_first_keypoints(i,:)];
                candidate_first_poses = [candidate_first_poses(i,:);...
                                        prev_state.candidate_first_poses(i)];
                cadidate_time_indxs = [candidate_time_indxs, ...
    ...
    curr_state.cadidate_time_indxs = cadidate_time_indxs;
